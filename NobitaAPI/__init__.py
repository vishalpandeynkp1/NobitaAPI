...
from NobitaAPI.func import (MORSE_CODE_DICT,payloads_response,gpt_4_mode,payload8)
from base64 import b64decode as m,b64encode as n
from NobitaAPI.words import wordshub
from PIL import Image, ImageDraw, ImageFont
from NobitaAPI.truth_dare import TRUTH,DARE
__version__ = "0.6.5.6"
...
class NobitaAPI:
    ...
    support group : https://t.me/nibita_support
    owner : @ll_NOBITA_BOT_DEVLOPER_ll
        """
        pass
    ...
    def datagpt(args:str):
        ...
        try:
            ...
            return {"results":data["text"],"join": "@NOBITA_ALL_BOT", "success": True
                    }
    ...
    def blackbox(args: str) -> requests.Response:
        ...
        try:
            ...
            if response.status_code == 200:
                return {"results": response.text, "join": "@NOBITA_ALL_BOT", "success": True}
        except Exception as e:
            return e  
    ...
    def chatgpt(args:str,mode:str=False):
        ...
        if not mode:
            ...
            return {"results":response.json()["response"],"join": "@NOBITA_ALL_BOT", "success": True}
        else:
            try:
                result = gpt_4_mode(args, mode)
                return {"results":result,"join": "@NOBITA_ALL_BOT", "success": True}
    ...
    def randomword():
        ...
        return {"results": word, "join": "@NOBITA_ALL_BOT", "sucess": True}
    ...
    def gemini(args: str) -> dict:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return {"results":generated_text,"join": "@NOBITA_ALL_BOT", "success": True}
        except Exception as e:
            return e
    ...
    """
        ...
        if response.status_code == 200:
            ...
            return {"results": image_urls, "join": "@NOBITA_ALL_BOT", "success": True}
        else:
    ...
    """
        ...
        return {"results": result, "join": "@NOBITA_ALL_BOT", "sucess": True}
    ...
    Example usage:
    >>> from NobitaAPI import api
    >>> search_results = api.github("NOBI")
    >>> print(search_results)
    """
